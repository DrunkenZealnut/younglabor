...
<article class="content-detail">
    ...
    <div class="section"><div class="container content-reading">
        <?php if (!empty($post['file_id'])): ?><figure class="detail-cover"><img src="<?php echo htmlspecialchars(url('media/' . (int)$post['file_id']), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars((string)$post['file_alt_text'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>"></figure><?php endif; ?>
