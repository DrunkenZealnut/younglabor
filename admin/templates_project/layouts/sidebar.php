...
<div class="sidebar">
  ...
  <a href="<?= t_url('settings/site_settings.php') ?>" <?= is_menu_active('settings', 'site_settings.php') ? 'class="active"' : '' ?>>
    🎨 디자인 설정
  </a>
  <a href="<?= t_url('settings/config_settings.php') ?>" <?= is_menu_active('settings', 'config_settings.php') ? 'class="active"' : '' ?>>
    ⚙️ 시스템 설정
  </a>
