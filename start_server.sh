...
# hopec 프로젝트 디렉토리로 설정
HOPEC_DIR="/Users/zealnutkim/Documents/개발/hopec"
echo "📁 웹 루트 디렉토리: $HOPEC_DIR"

# PHP 내장 서버 시작
echo "🌐 PHP 내장 서버를 시작합니다..."
echo "📍 접속 주소:"
echo "   - 메인 사이트: http://hopec.local:8013"
echo "   - 대체 주소: http://localhost:8013"
echo "   - 데이터베이스 관리: http://hopec.local:8013/db_manager.php"
echo ""
...
# PHP 서버 시작
php -S 0.0.0.0:8013 -t "$HOPEC_DIR"