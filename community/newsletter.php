    ...
    <div class="mb-8">
      <nav class="breadcrumb mb-4" aria-label="breadcrumb">
        <ol class="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <li class="before:content-['>'] before:mx-2 text-forest-600 font-medium">소식지</li>
        </ol>
      </nav>
      
      <h1 class="text-3xl font-bold text-forest-700 mb-2">소식지</h1>
      <p class="text-gray-600">희망씨의 다양한 소식지를 확인하세요.</p>
    </div>
