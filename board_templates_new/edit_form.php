...
<form method="post" action="<?php echo htmlspecialchars($config['action_url'] ?? '../board_templates/post_handler.php'); ?>" enctype="multipart/form-data" id="boardForm" class="board-edit-form" aria-describedby="formHelp">
