...
*/
// 로컬 개발 고정 도메인 (심볼릭 링크 환경에서 URL 계산 오류 방지)
// 반드시 실제 접근 경로를 명시합니다.
define('G5_DOMAIN', 'http://hopec.local:8012');
...
// G5_ADMIN_DIR, G5_BBS_DIR: 하위 호환을 위해 빈 문자열로 유지 (adm/, bbs/ 폴더는 삭제됨)
define('G5_ADMIN_DIR',      '');
define('G5_BBS_DIR',        '');
...
// 항상 HTTPS URL 사용 (Mixed Content 문제 방지)
