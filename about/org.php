...
<main id="container" role="main" class="<?= getThemeClass('bg', 'gray', '50') ?> min-h-screen">
  <article class="max-w-7xl mx-auto px-4 py-10">
    ...
    <section class="mb-16" aria-labelledby="directors">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        <div class="<?= getThemeClass('bg', 'white') ?> rounded-xl shadow-md p-6 relative pt-10 transform hover:-translate-y-1 transition-transform duration-300 border <?= getThemeClass('border', 'gray', '200') ?>">
          <div class="role-badge <?= getThemeClass('text', 'white') ?>" style="background-color: var(--primary);">상임이사</div>
        ...
        <div class="<?= getThemeClass('bg', 'white') ?> rounded-xl shadow-md p-6 relative pt-10 transform hover:-translate-y-1 transition-transform duration-300 border <?= getThemeClass('border', 'gray', '200') ?>">
          <div class="role-badge <?= getThemeClass('text', 'white') ?>" style="background-color: var(--primary);">이사</div>
    ...
    <section class="mb-8" aria-labelledby="auditors">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="<?= getThemeClass('bg', 'white') ?> rounded-xl shadow-md p-6 relative pt-10 transform hover:-translate-y-1 transition-transform duration-300 border <?= getThemeClass('border', 'gray', '200') ?>">
          <div class="role-badge <?= getThemeClass('text', 'white') ?>" style="background-color: var(--primary);">감사</div>
